...
class VLMConfig:
    ...
    lm_model_type: str = 'LiquidAI/LFM2.5-230M' #'HuggingFaceTB/SmolLM2-135M' or 'LiquidAI/LFM2.5-230M' or 'HuggingFaceTB/SmolLM2-360M-Instruct'
    lm_tokenizer: str = 'LiquidAI/LFM2.5-230M' # 'LiquidAI/LFM2.5-230M' or 'HuggingFaceTB/SmolLM2-360M-Instruct'
    ...
    # teacher patches.
    vision_backend: str = "vit" # "encoder_free" or "vit"
